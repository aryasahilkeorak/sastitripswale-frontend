// Indian states/UTs + their districts, used to drive the State/City select
// pairs across profile forms (CompleteProfile, ProfileEditForm, AdminProfile).
// "City" in this app's forms maps to "district" here - the standard
// administrative unit below state level in India.
...
export const DISTRICTS_BY_STATE = {
  ...
  Assam: [
    'Baksa', 'Barpeta', 'Bajali', 'Biswanath', 'Bongaigaon', 'Cachar', 'Charaideo', 'Chirang',
  ...
  'Madhya Pradesh': [
    ...
    'Khargone', 'Mandla', 'Mandsaur', 'Maihar', 'Mauganj', 'Morena',
    'Narmadapuram', 'Narsinghpur', 'Neemuch', 'Niwari', 'Panna', 'Pandhurna', 'Raisen', 'Rajgarh',
...
export const INDIAN_STATES = Object.keys(DISTRICTS_BY_STATE);
