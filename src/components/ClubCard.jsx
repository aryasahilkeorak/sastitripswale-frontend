    ...
    <div className="member-card" style={{ padding: 0, overflow: 'hidden' }}>
      ...
      <div style={{ padding: '0 28px 28px', textAlign: 'center', marginTop: -40 }}>
        ...
        <p className="member-meta" style={{ marginTop: 14 }}>
          <i className="fa-solid fa-users" /> {club.memberCount} member{club.memberCount === 1 ? '' : 's'}
        </p>
        {club.owner && (
        ...
        <div style={{ marginTop: 22 }}>
          ...
          >
            <i className={club.isMember ? 'fa-solid fa-comment-dots' : 'fa-solid fa-eye'} /> {club.isMember ? 'Open Club' : 'View Club'}
          </Link>
        </div>
      </div>
    </div>
